...
def main():
    ...
    parser.add_argument('--tasks', nargs='+', default=['div'], 
                        ...
                        help='List of tasks to train on (e.g. --tasks div mult)')
    ...
    model = SimpleTransformer(
        vocab_size=len(vocab), d_model=args.d_model, nhead=args.nhead, num_layers=args.num_layers
    )
    ...
    history = train_model(
        ...
        num_steps=args.num_steps, save_dir=args.checkpoint_dir
    )
